...
os.environ["DJANGO_SETTINGS_MODULE"] = "ipharm_web.settings"
...
project = "iPharm"
copyright = "2022, Conceptica s.r.o"
author = "Conceptica s.r.o."
...
man_pages = [(master_doc, "ipharm", "iPharm Documentation", [author], 1)]
...
def skip_queryset(app, what, name, obj, skip, options):
    ...
    if isinstance(obj, (models.QuerySet, models.manager.BaseManager)) or name.endswith(
        "objects"
    ):
        return True
    return skip
